...
public class GestNoteMathsFinales {
	...
	public static JLabel titre=new JLabel("NOTES FINALES DES ETUDIANTS T.C.M");
	...
	public static void ajouter() {
		...
		for(int i=0;i<panelPrincipale.length;i++) {
			...
			panelPrincipale[i]=new PanelNote("MATHEMATIQUES ET APPLICATIONS", nbrSems[i], i, debutSems[i],"final",sems,
	...
	public static class Visible implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			titre.setText("NOTES FINALES DES ETUDIANTS "+bout[i].getText());
