...
public class FenetreImpressionResultatLicence extends JDialog {
      ...
      String parcour,session,sems,ue;
		...
		public FenetreImpressionResultatLicence(DefaultTableModel model2,String mention,String parcour,
				String session,String sems,int k) {
        	  super();
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionResultatLicence.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionResultatLicence.this,"If non-interactive, the GUI is fully blocked"
              ...
              public Component getTableCellRendererComponent(JTable table, Object value,
                  ...
                  if(row==0) {
                	  ...
                	  JLabel titre=new JLabel("");
                	   titre=new JLabel("<html> <div id='bloc_page'> RESULTAT&nbsp;PROVISOIRE&nbsp;DE&nbsp;"
                	  		+ "LA&nbsp;LICENCE&nbsp;</div></html>");
                	...
                	pan.setBackground(Color.white);
                	  ...
                	  if(row!=model2.getRowCount()+2) {
		                 ...
		                 pan.add(nom);
                		  ...
                		  result=new JLabel("<html> <div id='bloc_page'><p>ARRETE&nbsp;LA&nbsp;PRESENTE&nbsp;LISTE&nbsp;AU&nbsp;NOMBRE&nbsp;"
                		  		+ "DE&nbsp;"+model2.getRowCount()+"&nbsp;ETUDIANT(S)&nbsp;</p>AYANT&nbsp;OBTENUE&nbsp;" 
                		  				                	 + "LES&nbsp;180&nbsp;CREDIT&nbsp;DE&nbsp;LA&nbsp;LICENCE</div></html>");
