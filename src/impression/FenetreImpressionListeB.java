...
public class FenetreImpressionListeB extends JFrame {
      ...
      protected JTextField footerField;
          ...
          @SuppressWarnings({ })
		public FenetreImpressionListeB(DefaultTableModel model,String titre) {
        	 
             super("Impression des Liste des étudiants Boursiè(e)s ");
             ...
             gradesLabel = new JLabel("Liste des étudiants Boursièr(e)s en "+titre);         
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           headerField = new JTextField("Liste des etudiants Boursièr(e)s et inscritent en "+titre);         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionListeB.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionListeB.this,"If non-interactive, the GUI is fully blocked"
