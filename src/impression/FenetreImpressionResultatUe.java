...
public class FenetreImpressionResultatUe extends JDialog {
      ...
      String parcour,session,sems,ue;
		...
		public FenetreImpressionResultatUe(DefaultTableModel model2,String mention,String parcour,
				String session,String sems,int k,String ue) {
        	  super();
            ...
            // JTable table = new JTable(new RssFeedTableModel(feeds)); 
			 ...
			 for(int i=0;i<model2.getRowCount();i++) {
				 feeds.add(new RecuperInfo(String.valueOf(model2.getValueAt(i, 0)), String.valueOf(model2.getValueAt(i, 1))
						 , String.valueOf(model2.getValueAt(i, 2))));
             ...
             gradesTable.setRowHeight(0,255);
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionResultatUe.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionResultatUe.this,"If non-interactive, the GUI is fully blocked"
            ...
            return this;         
              ...
              public Component getTableCellRendererComponent(JTable table, Object value,
                  ...
                  if(row==0) {
                	  ...
                	  JLabel titre=new JLabel("<html> <div id='bloc_page'> RESULTAT&nbsp;PROVISOIRE&nbsp;DE&nbsp;"
                	  		+ "L'UNITE&nbsp;D'ENSEIGNEMENT&nbsp;&nbsp;"+ue+"&nbsp;</div></html>");
                      ...
                      JLabel note=new JLabel("<html> <div id='bloc_page'>Note</div></html>");
                	  ...
                	  logo1.setIcon(ImageBonneQualite.image("C:/Program Files (x86)/JDev/DataSciences/image/logoUniv.png",70));
              		 ...
              		 num.setPreferredSize(new Dimension(80,15));
                     nom.setPreferredSize(new Dimension(440,15));
                     note.setPreferredSize(new Dimension(40,15));
                    ...
                    pan.add(note);
                	  ...
                	  if(row!=model2.getRowCount()+2) {
		                 ...
		                 JLabel note=new JLabel("<html> <div id='bloc_page'>"+feed.note+"</div></html>");
		                 num.setPreferredSize(new Dimension(80,20));
		                 nom.setPreferredSize(new Dimension(440,20));
		                 note.setPreferredSize(new Dimension(40,20));
		                 num.setHorizontalAlignment(JLabel.CENTER);
		                 ...
		                 pan.add(note);
                		  ...
                		  pan.setBackground(Color.white);
                		  JLabel result=new JLabel("<html> <div id='bloc_page'><p>ARRETE&nbsp;LA &nbsp;PRESENTE &nbsp;LISTE&nbsp;"
                		  		+ "AU&nbsp;NOMBRE&nbsp;"
                		  		+ "DE&nbsp;"+model2.getRowCount()+"&nbsp;ETUDIANT(S)&nbsp;</p>AYANT&nbsp;VALIDES&nbsp;" 
                		  				                	 + "L'UNITE&nbsp;D'ENSEIGNEMENT&nbsp;&nbsp;"+ue+"&nbsp;</div></html>");
                		  result.setPreferredSize(new Dimension(650,35));
                		  pan.add(result);
                	  }
                	  if(model2.getRowCount()==0) {
                		 JLabel nomn=new JLabel("Neant");
                		 nomn.setPreferredSize(new Dimension(440,20));
                		  pan.add(nomn);
                	  }
                  }
