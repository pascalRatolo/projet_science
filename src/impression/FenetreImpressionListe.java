...
public class FenetreImpressionListe extends JFrame {
      ...
      protected JTextField footerField;
          ...
          @SuppressWarnings({ })
		public FenetreImpressionListe(DefaultTableModel model,String titre) {
        	 
             super("Imperssion des Liste des étudinats ");
             ...
             gradesLabel = new JLabel("Liste des étudiant en "+titre);         
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           headerField = new JTextField("Listes des etudiant inscrit en "+titre);         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionListe.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionListe.this,"If non-interactive, the GUI is fully blocked"
