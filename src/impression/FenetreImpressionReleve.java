...
public class FenetreImpressionReleve extends JDialog {
      ...
      JPanel pan;
		public FenetreImpressionReleve(DefaultTableModel model,DefaultTableModel model2 , JPanel pan) {
        	  super();
        ...
        this.setModalityType(ModalityType.APPLICATION_MODAL);
  		this.addWindowListener(new WindowAdapter() {
            ...
            // JTable table = new JTable(new RssFeedTableModel(feeds)); 
             ...
             gradesTable.setRowHeight(model2.getRowCount()*20+170);
             gradesTable.setPreferredScrollableViewportSize(new Dimension(500,500));
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionReleve.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionReleve.this,"If non-interactive, the GUI is fully blocked"
