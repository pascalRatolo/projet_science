...
public class FenetreImpressionStatistiqueAge extends JDialog {
      ...
      JLayeredPane pan;
		public FenetreImpressionStatistiqueAge(DefaultTableModel model,DefaultTableModel model2 , JLayeredPane pan) {
        	  super();
        ...
        this.setModalityType(ModalityType.APPLICATION_MODAL);
  		this.addWindowListener(new WindowAdapter() {
            ...
            // JTable table = new JTable(new RssFeedTableModel(feeds)); 
             ...
             gradesTable.setRowHeight(590);
             gradesTable.setPreferredScrollableViewportSize(new Dimension(900,400));
        ...
        /* Set a custom renderer on the "Passed" column */         
           ...
           showPrintDialogBox.addActionListener(new ActionListener() {             
            public void actionPerformed(ActionEvent ae) {                 
                 ...
                 JOptionPane.showMessageDialog(FenetreImpressionStatistiqueAge.this,"If the Print Dialog is not shown,"+ " the default printer is used.", 
           ...
           interactiveBox.addActionListener(new ActionListener() {             
              public void actionPerformed(ActionEvent ae) {                 
                    if (!interactiveBox.isSelected()) {                     
                        JOptionPane.showMessageDialog(FenetreImpressionStatistiqueAge.this,"If non-interactive, the GUI is fully blocked"
