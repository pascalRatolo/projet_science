		...
		centerRenderer.setHorizontalAlignment(JLabel.CENTER);
		  ...
		  logo1.setPreferredSize(new Dimension(90,90));
     	  ...
     	  logo2.setIcon(ImageBonneQualite.image("C:/Program Files (x86)/JDev/DataSciences/image/logoFac.png",80));
     		...
     		parc=new JLabel("<html> <div id='bloc_page'>Année&nbsp;d'étude : "+niveau.getText()+" Mathématiques</div></html>");
			...
			modelDelib.addRow(new Object[] {"Filière","Serie A1","Serie A2","Serie C","Serie D",
					"<html> <p>Technique </p>Génie&nbsp;civile</html>","<html> <p>Technique </p>Industrielle</html>",
					"<html> <p>Technique </p>Tertiaire</html>","<html> <p>Technique </p>Agricole</html>","Technologique","Autre","Ensemble"});
			modelDelib.addRow(new Object[] {"Mathématiques","","","","","","","","","","","",""});
