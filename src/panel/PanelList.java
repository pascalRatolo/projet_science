...
public class PanelList extends JPanel{
	...
	public PanelList(String titre,JTable table,JButton bout,DefaultTableModel model) {
		this.titre=titre;
		this.table=table;
		this.bout=bout;
		this.model=model;
		...
		title=new JLabel ("LISTE DES ETUDIANTS EN "+titre);
		...
		bout1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				new FenetreImpressionListe(model, titre).setVisible(true);
