...
public class PanelBourseR extends JPanel{
	String titre;
	...
	public PanelBourseR(String titre,JTable table,JButton bout,DefaultTableModel model) {
		this.titre=titre;
		this.table=table;
		this.bout=bout;
		this.model=model;
		...
		title=new JLabel ("ETUDIANTS REDOUBLANTS BOURSIERS EN "+titre);
